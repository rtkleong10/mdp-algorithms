...
from image_reg_algo import ImageRegAlgo
...
class SimulatorGUI(GUI):
    ...
    def exploration(self):
        ...
        self.exp = ImageRegAlgo(self.robot, self.update_canvas, coverage_limit=self.coverage_limit_input.get() / 100, time_limit=self.time_limit_input.get())
